...
newTrial("selena",
    ...
    newSelector("shape")
        ...
        .wait()
    ,
    newText("The practice items are over. There will no longer be instructions above the picture to remind you that the white square indicates earlier and the black square indicates later. Now we will move on to the actual experiment. Click on the button below when you are ready")
        .print()
    ,
...
newTrial("selection5",
    newText("Remember, based on your opinion, if the second picture of the full orange takes place earlier than the first picture of the cut oranges, you will click the black square. If the second picture of the full orange takes place at a later point of time after the first picture of the cut oranges, you will click on the white square.")
        .center()
        .print()
    ,
...
newTrial("pumpkin2",
    ...
    getHtml("pumpkinearlier")
        .remove()
    ,
    newText("Remember, based on your opinion, if the second picture of the full pumpkin takes place earlier than the first picture of the sliced pumpkin, you will click the black square. If the second picture of the full pumpkin takes place at a later point of time after the first picture of the sliced pumpkin, you will click on the white square.")
        .center()
        .print()
    ,
...
newTrial("selena2",
    ...
    getHtml("selenalater")
        .remove()
    ,
    newText("Remember, based on your opinion, if the second picture of the woman is earlier than the first picture of the child, you will click the black square. If the second picture of the woman takes place at a later point of time after the first picture of the child, you will click on the white square.")
        .center()
        .print()
    ,
